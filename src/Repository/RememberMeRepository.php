...
use Jdwiese\ContaoEntitiesCoreBundle\Entity\RememberMe;
 ...
 * @method array|RememberMe[] findAll()
 * @method array|RememberMe[] findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class RememberMeRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(RememberMe $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(RememberMe $entity, bool $flush = true): void
    {
