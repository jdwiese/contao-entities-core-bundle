...
use Jdwiese\ContaoEntitiesCoreBundle\Entity\TrustedDevice;
 ...
 * @method array|TrustedDevice[] findAll()
 * @method array|TrustedDevice[] findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class TrustedDeviceRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(TrustedDevice $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(TrustedDevice $entity, bool $flush = true): void
    {
