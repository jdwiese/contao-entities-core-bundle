 ...
 * @method array|TlCalendar[] findAll()
 * @method array|TlCalendar[] findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class TlCalendarRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(TlCalendar $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(TlCalendar $entity, bool $flush = true): void
    {
