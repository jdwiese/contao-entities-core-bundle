 ...
 * @method array|TlStyleSheet[] findAll()
 * @method array|TlStyleSheet[] findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class TlStyleSheetRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(TlStyleSheet $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(TlStyleSheet $entity, bool $flush = true): void
    {
