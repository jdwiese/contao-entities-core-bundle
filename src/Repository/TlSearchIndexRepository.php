 ...
 * @method array|TlSearchIndex[] findAll()
 * @method array|TlSearchIndex[] findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class TlSearchIndexRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(TlSearchIndex $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(TlSearchIndex $entity, bool $flush = true): void
    {
