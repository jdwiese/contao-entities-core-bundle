 ...
 * @method array|TlNewsFeed[] findAll()
 * @method array|TlNewsFeed[] findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class TlNewsFeedRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(TlNewsFeed $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(TlNewsFeed $entity, bool $flush = true): void
    {
