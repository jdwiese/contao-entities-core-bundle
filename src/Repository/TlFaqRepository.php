 ...
 * @method array|TlFaq[] findAll()
 * @method array|TlFaq[] findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class TlFaqRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(TlFaq $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(TlFaq $entity, bool $flush = true): void
    {
