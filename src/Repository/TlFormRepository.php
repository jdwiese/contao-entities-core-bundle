 ...
 * @method array|TlForm[] findAll()
 * @method array|TlForm[] findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class TlFormRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(TlForm $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(TlForm $entity, bool $flush = true): void
    {
