 ...
 * @method array|TlCalendarEvents[] findAll()
 * @method array|TlCalendarEvents[] findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class TlCalendarEventsRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(TlCalendarEvents $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(TlCalendarEvents $entity, bool $flush = true): void
    {
