 ...
 * @method array|TlUserGroup[] findAll()
 * @method array|TlUserGroup[] findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class TlUserGroupRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(TlUserGroup $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(TlUserGroup $entity, bool $flush = true): void
    {
