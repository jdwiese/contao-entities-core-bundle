 ...
 * @method array|TlNews[] findAll()
 * @method array|TlNews[] findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class TlNewsRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(TlNews $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(TlNews $entity, bool $flush = true): void
    {
