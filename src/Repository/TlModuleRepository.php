 ...
 * @method array|TlModule[] findAll()
 * @method array|TlModule[] findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class TlModuleRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(TlModule $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(TlModule $entity, bool $flush = true): void
    {
