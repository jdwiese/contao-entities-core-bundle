 ...
 * @method array|SearchIndex[] findAll()
 * @method array|SearchIndex[] findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class SearchIndexRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(SearchIndex $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(SearchIndex $entity, bool $flush = true): void
    {
