 ...
 * @method array|TlTheme[] findAll()
 * @method array|TlTheme[] findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class TlThemeRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(TlTheme $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(TlTheme $entity, bool $flush = true): void
    {
