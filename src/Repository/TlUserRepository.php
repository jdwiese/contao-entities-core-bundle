 ...
 * @method array|TlUser[] findAll()
 * @method array|TlUser[] findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class TlUserRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(TlUser $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(TlUser $entity, bool $flush = true): void
    {
