 ...
 * @method array|TlCalendarFeed[] findAll()
 * @method array|TlCalendarFeed[] findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class TlCalendarFeedRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(TlCalendarFeed $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(TlCalendarFeed $entity, bool $flush = true): void
    {
