 ...
 * @method array|TlMember[] findAll()
 * @method array|TlMember[] findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class TlMemberRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(TlMember $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(TlMember $entity, bool $flush = true): void
    {
