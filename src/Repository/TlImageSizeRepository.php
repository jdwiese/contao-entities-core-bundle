 ...
 * @method array|TlImageSize[] findAll()
 * @method array|TlImageSize[] findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class TlImageSizeRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(TlImageSize $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(TlImageSize $entity, bool $flush = true): void
    {
