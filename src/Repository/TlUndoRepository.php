 ...
 * @method array|TlUndo[] findAll()
 * @method array|TlUndo[] findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class TlUndoRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(TlUndo $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(TlUndo $entity, bool $flush = true): void
    {
