 ...
 * @method array|TlPage[] findAll()
 * @method array|TlPage[] findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class TlPageRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(TlPage $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(TlPage $entity, bool $flush = true): void
    {
