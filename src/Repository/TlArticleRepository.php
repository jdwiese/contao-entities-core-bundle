 ...
 * @method array|TlArticle[] findAll()
 * @method array|TlArticle[] findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class TlArticleRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(TlArticle $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(TlArticle $entity, bool $flush = true): void
    {
